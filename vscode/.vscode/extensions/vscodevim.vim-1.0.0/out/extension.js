...
const configurationValidator_1 = require("./src/configuration/configurationValidator");
...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all([
            commandLine_1.commandLine.load(),
            globalState.load(),
            configurationValidator_1.configurationValidator.initialize(),
...
process.on('unhandledRejection', function (reason, p) {
    logger_1.logger.error(`Unhandled rejection. Promise ${p}. Reason: ${reason}.`);
});
