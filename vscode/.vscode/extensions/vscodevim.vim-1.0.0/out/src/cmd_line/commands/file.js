    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this._arguments.name === '') {
                ...
                if (filePath !== editorFilePath && !(yield util.promisify(fs.exists)(filePath))) {
                    ...
                    if (path.extname(filePath) === '') {
                        ...
                        if (yield util.promisify(fs.exists)(pathWithExt)) {
                    ...
                    if (this._arguments.createFileIfNotExists) {
                        ...
                        logger_1.logger.error(`file: ${filePath} does not exist.`);
                        return;
                    }
                }
            }
