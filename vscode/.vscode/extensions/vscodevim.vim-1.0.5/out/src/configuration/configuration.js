...
class Configuration {
    ...
    load() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let configurationErrors = new Array();
            ...
            for (const modeKeyBindingsKey of modeKeyBindingsKeys) {
                let keybindings = exports.configuration[modeKeyBindingsKey];
                const modeKeyBindingsMap = new Map();
                for (let i = keybindings.length - 1; i >= 0; i--) {
                    let remapping = keybindings[i];
                    // validate
                    let remappingErrors = yield configurationValidator_1.configurationValidator.isRemappingValid(remapping);
                ...
                exports.configuration[modeKeyBindingsKey + 'Map'] = modeKeyBindingsMap;
            }
            // wrap keys
            this.wrapKeys = {};
