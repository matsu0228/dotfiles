        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (this._arguments.operator) {
                ...
                case SetOptionOperator.Info:
                    ...
                    if (value === undefined) {
                        yield vscode.window.showErrorMessage(`${error_1.VimError.fromCode(error_1.ErrorCode.E518).toString()}. ${value}`);
                    }
                    else {
                        yield vscode.window.showInformationMessage(`${this._arguments.name}=${value}`);
                    }
                    break;
                default:
                    break;
