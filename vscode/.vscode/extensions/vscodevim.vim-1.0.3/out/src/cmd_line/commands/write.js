    ...
    execute(vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.arguments.opt) {
                logger_1.logger.warn('write: not implemented');
                return;
            }
            ...
            try {
                yield util.promisify(fs.access)(vimState.editor.document.fileName, fs.constants.W_OK);
                ...
                if (this.arguments.bang) {
                    fs.chmod(vimState.editor.document.fileName, 666, e => {
                        ...
                        statusBar_1.StatusBar.Set(e.message, vimState.currentMode, vimState.isRecordingMacro, true);
                        return;
                    });
                }
                else {
                    statusBar_1.StatusBar.Set(accessErr.message, vimState.currentMode, vimState.isRecordingMacro, true);
                }
            }
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            yield vimState.editor.document.save().then(() => {
                let text = '"' +
                    ...
                    'C written';
                statusBar_1.StatusBar.Set(text, vimState.currentMode, vimState.isRecordingMacro, true);
            }, e => statusBar_1.StatusBar.Set(e, vimState.currentMode, vimState.isRecordingMacro, true));
        });
    }
}
