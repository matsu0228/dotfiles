...
class NeovimWrapper {
    run(vimState, command) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.nvim) {
                ...
                yield this.nvim.uiAttach(80, 20, {
                    ext_cmdline: false,
                    ext_popupmenu: false,
                    ext_tabline: false,
                    ext_wildmenu: false,
                ...
                logger_1.logger.debug(`Neovim Version: ${version.major}.${version.minor}.${version.patch}`);
            }
            ...
            // Execute the command
            logger_1.logger.debug(`Neovim: Running ${command}.`);
    ...
    startNeovim() {
        return __awaiter(this, void 0, void 0, function* () {
            logger_1.logger.debug('Neovim: Spawning Neovim process...');
